...
// font
static char *fontstr = "xft:Ubuntu Nerd Font:style=Bold:pixelsize=30:antialias=true:hinting=true";
// tag names
static char *tags_names[] = { "1", "2", "3", "4", "5", "6", "7", "8", "9" };

// set 16-bit colors for bar
// use either pixman_color_t struct or HEX_COLOR macro for 8-bit colors
static pixman_color_t active_fg_color = HEX_COLOR(0xd8dee9ff);
static pixman_color_t active_bg_color = HEX_COLOR(0x638a96ff);
static pixman_color_t occupied_fg_color = HEX_COLOR(0xd8dee9ff);
static pixman_color_t occupied_bg_color = HEX_COLOR(0x758865ff);
...
static pixman_color_t middle_bg_color_selected = HEX_COLOR(0x2e3440ff);
