...
vim.api.nvim_create_user_command("NoteSync", "!python3 " .. script_path .. "sync.py", {})

vim.api.nvim_create_user_command("NoteUpdate", "!python3 " .. script_path .. "update.py <q-args>", { nargs = 1 })

vim.api.nvim_create_user_command("NoteRemove", "!python3 " .. script_path .. "remove.py <q-args>", { nargs = 1 })
